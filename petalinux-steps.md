...
3. Vitis will create a folder: [vitis platform dir]/hw/sdt, there should be a pl.dtsi file, it will be used in 13
...
7. Run "petalinux-config --get-hw-description /path/to/xsa" to do basic configuration
8. A terminal gui opens up, do the following:
   --DTG Settings->Kernel Bootargs->Uncheck "generate bookargs automatically"->
     Put "earlycon console=ttyPS0,115200 clk_ignore_unused uio_pdrv_genirq.of_id=generic-uio,ui_pdrv root=/dev/mmcblk0p2 rw rootwait" as the bootarg
