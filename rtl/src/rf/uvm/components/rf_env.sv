class rf_env extends uvm_env;
    ...
    uvm_tlm_analysis_fifo #(rf_program) agt2mdl_pgm_fifo;

    // agent sends captured trace to scoreboard
    uvm_tlm_analysis_fifo #(rf_trace) agt2sbd_trc_fifo;


    // model sends expected trace to scoreboard
    uvm_tlm_analysis_fifo #(rf_trace) mdl2sbd_trc_fifo;


    function new(string name = "env", uvm_component parent = null);
        super.new(name, parent);
        `uvm_info("rf_env", "new is called\n", UVM_LOW);
    endfunction
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        `uvm_info("rf_env", "build_phase is called\n", UVM_LOW);

        agt = rf_agent::type_id::create("agt", this);
        mdl = rf_model::type_id::create("mdl", this);
        sbd = rf_scoreboard::type_id::create("sbd", this);
    ...
    virtual function void connect_phase(uvm_phase phase);
        ...
        `uvm_info("rf_env", "connect_phase is called\n", UVM_LOW);
